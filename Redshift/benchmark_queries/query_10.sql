-- Query 10
-- Description: Calculates customer total orders, revenue, average revenue per order, and the percentage of orders shipped within 30 days, filtering for customers with a shipped ratio above 50%.
-- Difficulty: Hard
